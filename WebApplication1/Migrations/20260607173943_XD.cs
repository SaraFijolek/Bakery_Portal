    ...
    public partial class XD : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminPermissions", x => x.PermissionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminRolePermissions", x => x.RolePermissionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdminAuditLogs_Admin_AdminId",
                        column: x => x.AdminId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdminSessions_Admin_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admin",
                        principalColumn: "AdminId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdminSessions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportedContents", x => x.ReportId);
                    table.ForeignKey(
                        name: "FK_ReportedContents_Admin_AdminId1",
                        column: x => x.AdminId1,
                        principalTable: "Admin",
                        principalColumn: "AdminId");
                    table.ForeignKey(
                        name: "FK_ReportedContents_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReportedContents_AspNetUsers_ReporterUserId",
                        column: x => x.ReporterUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReportedContents_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserModerations", x => x.ModerationId);
                    table.ForeignKey(
                        name: "FK_UserModerations_Admin_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admin",
                        principalColumn: "AdminId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserModerations_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "UserSocialAuths",
                columns: table => new
                {
                    SocialAuthId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSocialAuths", x => x.SocialAuthId);
                    table.ForeignKey(
                        name: "FK_UserSocialAuths_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Admedias", x => x.MediaId);
                    table.ForeignKey(
                        name: "FK_Admedias_Ads_AdId",
                        column: x => x.AdId,
                        principalTable: "Ads",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdModerations", x => x.ModerationId);
                    table.ForeignKey(
                        name: "FK_AdModerations_Admin_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admin",
                        principalColumn: "AdminId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdModerations_Ads_AdId",
                        column: x => x.AdId,
                        principalTable: "Ads",
                        principalColumn: "AdId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdModerations_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdModerations_AdId",
                table: "AdModerations",
                column: "AdId");

            migrationBuilder.CreateIndex(
                name: "IX_AdModerations_AdminId",
                table: "AdModerations",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_AdModerations_UserId",
                table: "AdModerations",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportedContents_AdminId",
                table: "ReportedContents",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportedContents_AdminId1",
                table: "ReportedContents",
                column: "AdminId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportedContents_UserId",
                table: "ReportedContents",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserModerations_UserId",
                table: "UserModerations",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSocialAuths_UserId",
                table: "UserSocialAuths",
                column: "UserId");
        }
